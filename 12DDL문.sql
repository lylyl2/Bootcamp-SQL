...
CREATE TABLE DEPTS (
    ...
    DEPT_CONTENT LONG --최대 2기가 가변문자열 (VARCHR2보다 더 큰 문자열), 많이 사용 X //너무 크니까
);

DESC DEPTS;

INSERT INTO DEPTS VALUES(99, 'HELLO', 'Y', SYSDATE, 3.14, 'HELLO WORLD~~ BYE');
INSERT INTO DEPTS VALUES(100, 'HELLO', 'N', SYSDATE, 3.14, 'HELLO WORLD'); --DEPT_NO 초과 //숫자2자리 초과
INSERT INTO DEPTS VALUES(10, 'HELLO', '가', SYSDATE, 3.14, 'HELLO'); --DEPT_YN 초과
SELECT * FROM DEPTS;
...
ALTER TABLE DEPTS MODIFY DEPT_NAME VARCHAR2(1); --X 기존데이터가 변경할 크기를 넘어가는 경우, 변경 불가
DESC DEPTS;
...
INSERT INTO DEPT2 VALUES(123, 'HELLO HOW ARE U', 1234, 'Y', SYSDATE, 3.14159);
SELECT * FROM DEPT2;