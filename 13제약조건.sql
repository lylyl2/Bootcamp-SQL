...
DESC ABC;
SELECT * FROM ABC;
INSERT INTO ABC(M_NAME, M_NUM, REG_DATE, GENDER, LOCA)
...
ALTER TABLE MEMEBRS ADD COONSTRAINT MEM_REGDATE_UK UNIQUE;
DROP TABLE MEMBERS;
...
CREATE TABLE BOOK_HISTORY (
    ...
    CONSTRAINT HISTORY_NUM_FK FOREIGN KEY (BOOK_NUM) REFERENCES BOOK(BOOK_NUM),
